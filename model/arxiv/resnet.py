...
def ResNet18(_num_classes=10):
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes=_num_classes)


def ResNet34(_num_classes=10):
    return ResNet(BasicBlock, [3, 4, 6, 3], num_classes=_num_classes)


def ResNet50(_num_classes=10):
    return ResNet(Bottleneck, [3, 4, 6, 3], num_classes=_num_classes)


def ResNet101(_num_classes=10):
    return ResNet(Bottleneck, [3, 4, 23, 3], num_classes=_num_classes)


def ResNet152(_num_classes=10):
    return ResNet(Bottleneck, [3, 8, 36, 3], num_classes=_num_classes)
